        ...
        <RevealGroup className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {process.map((step) => (
            <RevealItem key={step.step} className="h-full">
              <div className="group relative h-full rounded-2xl border border-cream/15 bg-cream/[0.06] p-7 transition-colors duration-300 hover:border-gold/40 hover:bg-cream/[0.1]">
                ...
                <p className="mt-2 text-cream/80">{step.text}</p>
              </div>
            </RevealItem>
          ))}
        </RevealGroup>
