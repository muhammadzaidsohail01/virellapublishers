/** Simple, recognizable social brand icons (the icon library dropped these). */
...
export function XIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18.9 2h3.3l-7.2 8.24L23.5 22h-6.6l-5.18-6.77L5.8 22H2.5l7.7-8.8L2.1 2h6.77l4.68 6.19L18.9 2zm-1.16 18h1.83L7.02 3.9H5.06L17.74 20z" />
    </svg>
  );
}
